                                ...
                                <div class="row main-row">
                                    ...
                                    <div class="col-sm-6 col-xs-12" id="title-video">
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/C7Ixz6sr6kA?wmode=transparent&fs=1" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                                <div class="row main-row" id="afterlogin" runat="server" visible="False">
                                    <div class="col-xs-12" id="secondary-title">
                                        ...
                                        <h3>ספר חדש על תולדות הרוק העולמי מאת נעם רפפורט</h3>
                            ...
                            <div class="main-row">
                                <div class="col-sm-6 col-xs-12 pull-right ">
                                    <div id="main-description">
                                        ...
                                        <h6 style="text-align: justify; margin-top: 0">הי, אני נעם.<br />
                                    ...
                                    <div class="row ">
                                        <div class="col-xs-12">
                                            ...
                                            <h6 style="text-align: justify; margin-top: 0">ב<strong>שישה ביולי 1957</strong>, נפגשו לראשונה ג'ון לנון ופול מקרטני.<br />
                                                ...
                                                הפיצו עכשיו את הקישור ותעזרו לי להגשים את החלום.<br />
                                                <br />
